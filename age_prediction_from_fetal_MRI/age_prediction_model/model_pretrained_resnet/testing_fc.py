...
## for training change following line to:
# model = torch.load('model_age_prediction.pt')
model = torch.load('save_model_weights/best_model_pretrained/model_age_prediction.pt')
...
################### Run the testing on Test Images #####################
with torch.no_grad():
    for images, labels in test_loader:
        images = images.float()  # Add channel dimension
...
age_data_chronlogical           =    np.sort(chronological_age) 
