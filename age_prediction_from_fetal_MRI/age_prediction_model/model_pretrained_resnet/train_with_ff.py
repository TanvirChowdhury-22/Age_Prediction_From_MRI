...
model_fc           = FNN() # load Fully connected network 
#torch.load('model_age_prediction.pt') #FNN()
...
for epoch in range(num_epochs):
    ...
    results_val             = subprocess.check_output(f'python3 model_pretrained_resnet/testing_fc.py',shell=True)
